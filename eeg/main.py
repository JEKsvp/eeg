...
custom_plt.custom_specgram(axes[0, 1], dbuilder.butter_highpass_filter(channels[0], sampling_frequency, 2), sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[1, 1], dbuilder.butter_highpass_filter(channels[1], sampling_frequency, 2), sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[2, 1], dbuilder.butter_highpass_filter(channels[2], sampling_frequency, 2), sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[3, 1], dbuilder.butter_highpass_filter(channels[3], sampling_frequency, 2), sampling_frequency, frequency_limit=spec_max_frequency)
...
t1, max_freqs_1 = dbuilder.max_frequencies_with_float_window(dbuilder.butter_highpass_filter(channels[0], sampling_frequency, 2), sampling_frequency, 1, 0.9)
t2, max_freqs_2 = dbuilder.max_frequencies_with_float_window(dbuilder.butter_highpass_filter(channels[1], sampling_frequency, 2), sampling_frequency, 1, 0.9)
t3, max_freqs_3 = dbuilder.max_frequencies_with_float_window(dbuilder.butter_highpass_filter(channels[2], sampling_frequency, 2), sampling_frequency, 1, 0.9)
t4, max_freqs_4 = dbuilder.max_frequencies_with_float_window(dbuilder.butter_highpass_filter(channels[3], sampling_frequency, 2), sampling_frequency, 1, 0.9)
