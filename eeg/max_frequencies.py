...
custom_plt.custom_style(axes[0], max_freqs_1, frame_duration / len(t1))
custom_plt.custom_style(axes[1], max_freqs_2, frame_duration / len(t2))
custom_plt.custom_style(axes[2], max_freqs_3, frame_duration / len(t3))
custom_plt.custom_style(axes[3], max_freqs_4, frame_duration / len(t4))
plt.show()