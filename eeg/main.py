...
custom_plt.custom_specgram(axes[0, 1], channels[0], sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[1, 1], channels[1], sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[2, 1], channels[2], sampling_frequency, frequency_limit=spec_max_frequency)
custom_plt.custom_specgram(axes[3, 1], channels[3], sampling_frequency, frequency_limit=spec_max_frequency)
...
t1, max_freqs_1 = dbuilder.max_frequencies_with_float_window(channels[0], sampling_frequency, 1, 0.05)
t2, max_freqs_2 = dbuilder.max_frequencies_with_float_window(channels[1], sampling_frequency, 1, 0.05)
t3, max_freqs_3 = dbuilder.max_frequencies_with_float_window(channels[2], sampling_frequency, 1, 0.05)
t4, max_freqs_4 = dbuilder.max_frequencies_with_float_window(channels[3], sampling_frequency, 1, 0.05)
